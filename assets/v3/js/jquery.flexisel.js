! function(e) {
    e.fn.flexisel = function(t) {
        var n, i, l, a, o = e.extend({
            ...
            h = {
                ...
                initializeItems: function() {
                    ...
                    var a = s.children();
                    a.first().addClass("index1"), n = h.getCurrentItemWidth(), i = a.length, a.width(n), r.infinite && (h.offsetItemsToBeginning(Math.floor(a.length / 2)), s.css({
                ...
                setEventHandlers: function() {
                    ...
                    e(window).on("resize", function(a) {
                        c = !1, clearTimeout(l), l = setTimeout(function() {
                            ...
                            }) : (h.clearDisabled(), e(r.navigationTargetSelector).find(".nbs-flexisel-nav-left").addClass("disabled"), s.css({
                                left: 0
                            })), r.resize.call(t, s)
                        }, 100)
                ...
                calculateNonInfiniteLeftScroll: function(t) {
                    return h.clearDisabled(), h.getOffsetPosition() + t >= 0 ? (e(r.navigationTargetSelector).find(".nbs-flexisel-nav-left").addClass("disabled"), 0) : h.getOffsetPosition() + t
                },
                calculateNonInfiniteRightScroll: function(t) {
                    h.clearDisabled();
                    var l = i * n - f * n;
                    return h.getOffsetPosition() - t <= -l ? (e(r.navigationTargetSelector).find(".nbs-flexisel-nav-right").addClass("disabled"), -l) : h.getOffsetPosition() - t
                },
        ...
        return h[t] ? h[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error('Method "' + method + '" does not exist in flexisel plugin!') : h.init.apply(this)
    }
}(jQuery);