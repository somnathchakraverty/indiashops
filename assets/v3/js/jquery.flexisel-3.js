        ...
        var n, i, l, a, o = e.extend({
            ...
            h = {
                ...
                initializeItems: function() {
                    ...
                    var a = s.children();
                    a.first().addClass("index3"), n = h.getCurrentItemWidth(), i = a.length, a.width(n), r.infinite && (h.offsetItemsToBeginning(Math.floor(a.length / 2)), s.css({
                        left: -n * Math.floor(a.length / 2)
                    })), e(window).trigger("resize"), s.fadeIn(), r.loaded.call(this, s)
                },
                appendHTML: function() {
                    if (s.addClass("nbp-flexisel3-ul"), s.wrap("<div class='nbp-flexisel3-container'><div class='nbp-flexisel3-inner'></div></div>"), s.find("li").addClass("nbp-flexisel3-item"), r.navigationTargetSelector && e(r.navigationTargetSelector).length > 0 ? e("<div class='nbp-flexisel3-nav-left'></div><div class='nbp-flexisel3-nav-right'></div>").appendTo(r.navigationTargetSelector) : (r.navigationTargetSelector = s.parent(), e("<div class='nbp-flexisel3-nav-left'></div><div class='nbp-flexisel3-nav-right'></div>").insertAfter(s)), r.infinite) {
                        var t = s.children(),
                            n = t.clone(),
                            i = t.clone();
                ...
                setEventHandlers: function() {
                    ...
                    e(window).on("resize", function(a) {
                        c = !1, clearTimeout(l), l = setTimeout(function() {
                            ...
                            }) : (h.clearDisabled(), e(r.navigationTargetSelector).find(".nbp-flexisel3-nav-left").addClass("disabled"), s.css({
                                left: 0
                            })), r.resize.call(t, s)
                        }, 100)
                    }), e(r.navigationTargetSelector).find(".nbp-flexisel3-nav-left").on("click", function(e) {
                        h.scroll(!0)
                    }), e(r.navigationTargetSelector).find(".nbp-flexisel3-nav-right").on("click", function(e) {
                        h.scroll(!1)
                ...
                calculateNonInfiniteLeftScroll: function(t) {
                    return h.clearDisabled(), h.getOffsetPosition() + t >= 0 ? (e(r.navigationTargetSelector).find(".nbp-flexisel3-nav-left").addClass("disabled"), 0) : h.getOffsetPosition() + t
                },
                calculateNonInfiniteRightScroll: function(t) {
                    h.clearDisabled();
                    var l = i * n - f * n;
                    return h.getOffsetPosition() - t <= -l ? (e(r.navigationTargetSelector).find(".nbp-flexisel3-nav-right").addClass("disabled"), -l) : h.getOffsetPosition() - t
                },
                ...
                clearDisabled: function() {
                    ...
                    t.find(".nbp-flexisel3-nav-left").removeClass("disabled"), t.find(".nbp-flexisel3-nav-right").removeClass("disabled")
                }
            };
        return h[t] ? h[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error('Method "' + method + '" does not exist in flexisel3 plugin!') : h.init.apply(this)
    }
}(jQuery);