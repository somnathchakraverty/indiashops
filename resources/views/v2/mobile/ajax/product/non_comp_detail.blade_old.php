...
<div class="breadcrumb-bg">
  <div class="container"> {!! Breadcrumbs::render("p_detail_new",$product) !!} </div>
</div>
<!--PART-1-->
<div class="container">
...
<div class="fullbgpro" style="margin:10px 0px 20px 0px;padding-bottom:15px;">
  <div class="container">
    ...
    <div class="slick-thumbs">
      <ul>
        @foreach( $images as $key => $image )
        <li class="{{( $key ==0 ) ? 'active' : ''}}"> <a data-target="#pic-{{$key}}" data-toggle="tab"> <img src="{{getImageNew($image, 'XS')}}"/> </a> </li>
        @endforeach
      </ul>
    </div>
    ...
    <div class="row">
      <div class="col-xs-6">
        <div class="vendorlogomobile"> <a href="{{$product->product_url}}" target="_blank" onClick="ga('send', 'event', 'shop', 'click_mobile');" rel="nofollow"> <img src="{{config('vendor.vend_logo.'.$product->vendor )}}" alt="{{config('vendor.name.'.$product->vendor )}} Image" class="img-responsive"> </a> </div>
      </div>
      <div class="col-xs-6"> <a href="{{$product->product_url}}" target="_blank" onClick="ga('send', 'event', 'shop', 'click_mobile');" rel="nofollow" class="btn-success" style="margin-top:10px!important;">Buy Now</a> </div>
    </div>
    @endif </div>
</div>
  ...
  <div class="container">
    <div class="fullwidth">
      <ul id="flexiselDemo1">
        ...
        <li>
          <div class="thumnail">
            <div class="productboxallcat"> <a href="{{product_url($product)}}"> <img class="productallcatimg" src="{{getImageNew($product->image_url, 'M')}}"
                                 alt=""> </a> </div>
            <div class="productname"> <a href="{{product_url($product)}}"> {{$product->name}} </a> </div>
            <div class="star-ratingreviews">
              <div class="star-ratings-sprite"> <span style="width:52%" class="star-ratings-sprite-rating"></span> </div>
            </div>
            <a href="{{product_url($product)}}" class="price"> Rs. {{number_format($product->saleprice)}} </a> </div>
        </li>
        @endforeach
      </ul>
    </div>
