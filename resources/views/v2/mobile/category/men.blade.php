<?php
    $big_cat = ['Shoes','Clothing', 'Innerwear/Sleepwear', 'Accessories'];
...
<div class="container">
  <h5 class="catnameproduct"> <a href="{{newUrl( create_slug($category->group_name)."/".seoUrl(create_slug( $category->name )))}}">{{ucfirst($category->group_name)}}'s {{$category->name}}</a> </h5>
</div>
<div class="fullbgpro">
  <div class="container">
