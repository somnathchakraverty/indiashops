    ...
    <section style="background-color:#fff;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="sub-menu">
                        <li><a href="{{route("home_v2")}}">Home</a> >>  <a href="#">Career</a> </li>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 PL0">
                    ...
                    <div class="col-md-7">
                        ...
                        <p><span style="color:#e40046;font-weight:bold;">Send in your CV to hr@indiashopps.com</span> and stand a chance to be a part of the revolution.</p>
                        <div class="oppingjob">
                    ...
                    <div class="col-md-5"><img class="img-responsive" src="{{asset('assets/v2/')}}/images/career.jpg"></div>
                </div>
            </div>
        </div>
    </div>
