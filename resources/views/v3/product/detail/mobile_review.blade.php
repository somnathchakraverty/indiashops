...
@section('page_content')
    ...
    <div class="container whitecolorbg margintop">
                            ...
                            @if( isset($reviews->{$vendor}) && !empty($reviews->{$vendor}) )
                                <li>{{ucwords(config('vendor.name.'.$vendor))}}
                                    <div class="star-ratingreviews">
                                        <div class="str-rtg">
                                            <span style="width:{{percent($rating->{$vendor},5)}}%" class="str-ratg" title="{{ $rating->{$vendor} }} Stars (Out Of 5)"></span>
                                        </div>
                                    </div>
                                </li>
                            @endif
        ...
        <div class="col-md-4 pright">
            <div class="reviewnewpagetop">
                <div class="col-md-3">
                    <img class="productimgreviewnew" src="{{getImageNew($images[0], 'S')}}" alt="mobile">
                </div>
                <div class="col-md-9">
                    ...
                    @if( isset($reviews->{$vendor}) && !empty($reviews->{$vendor}) )
                        <div role="tabpanel" class="tab-pane {{($key++ == 0) ? 'active' : ''}}" id="tab{{$vendor}}">
                                            ...
                                            <div class="reviewleftsec">
                                                ...
                                                <div class="leftpartreviewcont">
                                                    ...
                                                    <div class="star-ratingleftsec">
                                                        <div class="str-rtg" style="text-align:center;margin:5px auto;">
                                                            <span style="width:{{percent($review->user_rating,5)}}%" class="str-ratg"></span>
                                                        </div>
                                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <a class="btn btn-danger load_more_reviews" href="javascript:;" vendor="{{$vendor}}" page="2" pid="{{$pid}}">Load
                                        More...</a>
                                </div>
                            </div>
                        </div>
