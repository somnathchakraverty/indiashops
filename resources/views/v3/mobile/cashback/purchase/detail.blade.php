...
@section('cashback_section')
    <style type="text/css">
        ...
        .btn-orange {color:#fff!important;background:#ff3131!important;margin-top:10px!important;padding:6px;border-radius:4px;display:inline-block;text-align:center!important;font-size:13px;font-weight:bold;}
            ...
            <div class="claim-messages" id="product_list">
                ...
                <div class="table-responsive text-center">
                    <table class="table">
                        ...
                        @include('v3.mobile.cashback.purchase.products')
                        </tbody>
                    </table>
                    <div class="col-md-12">
