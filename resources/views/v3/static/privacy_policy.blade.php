...
@section('page_content')
    ...
    <div class="container">
        <div class="sub-title mtop2">Privacy Policy and Terms & Conditions</div>
        <div class="privacy-policy">
            <p>This privacy policy has been compiled to better serve those who are
                ...
                or to identify an individual in context. Please read our privacy policy carefully to get a
            ...
            <strong>What personal information do we collect from the people that visit our blog, website or
                app?</strong>
            <p>When ordering or registering on our site, as appropriate, you may be
                asked to enter your name, email address, mailing address, phone number or other details to
                help you with your experience.</p>
            <strong>When do we collect information?</strong>
            <p>We collect information from you when you register on our site, subscribe
                to a newsletter, respond to a survey, fill out a form or enter information on our site.
            </p>
            ...
            <p> We may use the information we collect from you when you register, make a
                ...
                the website, or use certain other site features in the following ways:</p>
            <ul>
                <li> To personalize
                    your experience and to allow us to deliver the type of content and product offerings in
            ...
            <p>We only provide articles and information. We never ask for credit card
                numbers.
            </p>
            ...
            <p>You can choose to have your computer warn you each time a cookie is
            ...
            <p>If you turn cookies off, some features will be disabled. It won't affect
            ...
            <p>Google's advertising requirements can be summed up by Google's
            ...
            <p>We have not enabled Google AdSense on our site but we may do so in the
                future.
            </p>
            ...
            <p>CalOPPA is the first state law in the nation to require commercial
                websites and online services to post a privacy policy. The law's reach stretches well beyond
            ...
            <p>We do not specifically market to children under the age of 13 years
                old.
            </p>
            ...
            <strong>In order to be in line with Fair Information Practices we will
                take the following responsive action, should a data breach occur:</strong>
            ...
            <strong>If at any time you would like to unsubscribe from receiving
                future emails, you can email us at</strong>
            <ul>
                <li>
            ...
            <strong>indiashopps.com</strong>
            <p>761 A, JMD Megapolis</p>
            <p>Gurgaon, Haryana 122018</p>
            <p>India</p>
            <strong>info@indiashopps.com</strong>
            <p>Last Edited on 2017-02-09</p>
        </div>
    </div>
@endsection