...
<section id="contactus" class="overlay-contactus">
    <div class="container">
        ...
        @if(($product->saleprice != 0) and ($product->track_stock==1) && (isset($product->availability) &&
    ...
    <div>
        <amp-accordion>
                ...
                <div id="list-item-2" data-sort-time="1462814963693" class="amp-live-list-item">
                    ...
                    <div class="card">
                        ...
                        <div class="side side-right">
                            ...
                            <div class="logo"><a href="<?=$val->product_url?>" class="shopnowbut">Shop&nbsp;Now</a>
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
            ...
            @if(isset($product->specification) && !empty($product->specification))
                <section>
                    <h4>Specification and features of {{$product->name}}</h4>
                    <div class="description-list">
                        <ul>
                            {!! amp_desc_table_to_div($product->specification) !!}
                        </ul>
                    </div>
                </section>
            @endif
