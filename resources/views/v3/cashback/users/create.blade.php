...
@section('cashback_section')
    <style type="text/css">
        ...
        .btn-outline-primary { color: #fff !important; float:left; background: #ff3131 !important; margin: 10px 15px 0px 0px !important; }
		...
		.radio, .checkbox{margin-left:0px!important;}
		.permissions{font-size:18px;margin-top:15px;padding:0px;}
    </style>
    <div class="row">
        <div class="col-md-12">
