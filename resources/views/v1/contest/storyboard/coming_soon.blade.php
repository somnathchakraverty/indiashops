...
<head>
	...
	<meta property="og:title" content="Valentine day contest 2017, Showcase your valentine moments online | Indiashopps.com" />
	<meta property="og:description" content="Valentine's day contest 2017 showcase your valentine moments online in a storyboard." />
	...
	.alert{background: #1c6d22}
	</style>

	<!-- jQuery -->
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
<script src="<?php echo asset("contest/storyboard/js/bootstrap.min.js") ?>"></scri
	<!-- Modernizr -->
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="<?php echo asset("contest/storyboard/images/logo.png") ?>">
			    				
			<h1 id="cspio-headline">Valentine's day contest 2017 showcase your valentine moments online in a storyboard.</h1>			    				
			
			<div id="cspio-description">Valentine's day contest 2017 showcase your valentine moments online in a storyboard.</div>			    				
			...
			<form id="cspio-form" action="{{url('storyboard/album')}}" method="post">
			...
			<div id="cspio-socialprofiles">
				<a href="https://www.facebook.com/indiashopps?ref=hl" target="_blank"><i class="fa fa-facebook-official fa-2x"></i></a>			
				<a href="https://twitter.com/IndiaShopps" target="_blank"><i class="fa fa-twitter fa-2x"></i></a>			
