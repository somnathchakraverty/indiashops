...
<meta name="description" content="Valentine's day contest 2017 no better time to declare your love than this time! Right?">
<meta name="keyword" content="Valentine day story, Valentine day quotation, Valentine special story, Valentine special quotation, Valentine story">
<style type="text/css">
body {
  background:url(<?php echo asset("contest/valentine/images/albg.jpg")?>) no-repeat top center;
  margin:0;
  height:530px;
}
</style>

<title>Valentine day contest 2017, Submit quotation to declare your love | Indiashopps.com</title>
...
<section>
  <div class="container">
    <!--<div class="albums" style="margin-top:110px;">
      <h1 style="font-size:12px!important; font-weight:bold; text-transform:uppercase;">Explore the poetic side of yours</h1>
    </div>-->
    <div class="albumsbgcolor" style="margin-top:100px;">
     <h1 class="excitingprizes">Explore the poetic side of yours</h1>
      <div class="loginpagecon" style="padding:20px; text-align:center;">
      <p style="text-align:left;">There is something utterly creative on this Valentine’s Day. Share your self-created poems and quotations on love with us and win tempting prizes.<p>
      <ul style="margin:20px 0px 0px -24px;">
      <li style="text-align:left;">Please do not copy any stuff from the internet.  </li>
      <li style="text-align:left;">We will only entertain the original creation.</li>
	  <li style="text-align:left;">This is contest sponsered by IndiaShopps.com. </li>
	  <li style="text-align:left;">IndiaShopps will inform the winners through emails and phone numbers (if available) at their registered email IDs.</li>
      </ul>
      </div>
	...
	@endforeach
      ...
      <div class="formboxvideo">
       {!! Form::open(array('url'=>'contest/quotation','method' => 'post')) !!}	   
          <div class="form-group">
            <input type="text" class="form-control formcontrolconkut" id="exampleInputName2" placeholder="Mobile Number" name="mobile_number" max="10">
          </div>
          <div class="form-group">
            <input type="email" class="form-control formcontrolconkut" id="exampleInputEmail2" placeholder="E-mail Id" name="email">
          </div>
          <div class="form-group">
            <textarea class="form-control" rows="3" placeholder="Message" name="message"></textarea>
          </div>
          <button type="submit" class="btn btn-default" style="background-color:#337ab7;border-color:#2e6da4; color:#FFFFFF; font-size:17px;">Submit</button>
        {!! Form::close() !!}
      </div>


    <h4 class="excitingprizes2" style="margin:30px 0px 10px 25px;">Selection Criteria:</h4>
     <ul>
     <li style="text-align:left;">How deeply, artistically and effectively you have penned down your thoughts.</li>
     </ul>
...
<script src="<?php echo asset("contest/valentine/js/thumbnail-slider.js")?>"></script>
