...
<head>
  ...
  <link rel="stylesheet" href="<?php echo asset("/valentine/v1/css/banner.css")?>">
...
<div class="navbar navbar-default" role="navigation">
    <div class=container>
      <div class=navbar-header>
        ...
        <a class="navbar-brand" href="#"><img src="<?php echo asset("/valentine/v1/images/indiashopps_logo-final2.png")?>"/></a> </div>
...
<div class="productbgimnew">
  ...
  <div class="container">
    <div class="col-md-3">
      <div class="bgcolor">
        <div class="giftshedding">TOP GIFTS FOR HIM</div>	<!-- Left links -->
        <div class="giftslist">
          <ul>
          @if(isset($list_him))
    ...
    <div class="col-md-9">
      <div class="productnamehedding">Top Products Him</div>
      <nav>
...
<section>
  <div class="bordertop"></div>
  <div class="container">
    <h3 style="text-align:center;">{{ucwords($day)}} Day</h3>
    @if(isset($text))
      <?php echo $text; ?>
    @endif
...
<script src="<?php echo asset("/valentine/v1/js/easing.min.js")?>"></script>
